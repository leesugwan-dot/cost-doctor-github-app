...
def run_false_pass_probes(packet: dict[str, Any]) -> dict[str, Any]:
    ...
    tampered = deepcopy(packet); tampered["claim"]["grade"] = "PROVIDER_USAGE_WITH_VERIFIED_PRICE"; probes["claim_grade_promotion_blocked"] = validate_three_stage(tampered)["verdict"] != "PASS"
