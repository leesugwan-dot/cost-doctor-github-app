...
- private repository는 현재 무료 공개 진단 대상이 아닙니다.
- 별도 외부 telemetry 수집 서비스는 연결돼 있지 않습니다.
- GitHub Issue와 Actions 기록의 저장·보존·삭제는 GitHub의 서비스 정책과 저장소 설정의 적용을 받습니다.
...
이 문서는 법률 자문이나 최종 개인정보처리방침이 아닙니다. 정식 서비스·유료화·private repository 지원 전에 운영주체, 문의 채널, 보존기간, 삭제 절차, 관할 법률, 이용약관을 사람이 확정해야 합니다.
